...
// --- Init ---
// A chat widget önállóan inicializálódik a /chat-widget.js-ből (data-tender="c").
...
const STEPS_DATA = {
  ...
  4: {
    ...
    Belépés → Pályázati árkalkulációk → Új árkalkuláció → DIMOP Plusz-1.2.6/C-26<br>
  ...
  6: {
    ...
    html: `<strong>Benyújtási időszak: 2026.06.16 - 08.11</strong><br><br>
...
const SLIDES = {
  ...
  4: [
    { icon: '🛒', title: '4. Árkalkuláció', subtitle: 'Szállító és szoftver kiválasztás', body: `<ul>
      ...
      <li>Pályázat: <strong>DIMOP Plusz-1.2.6/C-26</strong></li>
  ...
  6: [
    { icon: '🚀', title: '6. Benyújtás', subtitle: '2026.06.16 - 08.11', body: `<ul>
