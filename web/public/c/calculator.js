...
function recalculate() {
  ...
  // C-26 (Budapest-only): területi bónusz interim 0 a hivatalos felhívás megerősítéséig.
  ...
  modal.innerHTML = `
    <div class="region-modal">
      <div class="region-modal-header">
        <h3>DIMOP Plusz-1.2.6/C-26 — kizárólag budapesti megvalósítás</h3>
      ...
      <div class="region-modal-body">
        <svg viewBox="0 0 800 500" class="region-map-svg">
          ...
          <!-- Budapest / Közép-Mo -->
          <path d="M310,130 L370,110 L400,140 L390,180 L360,200 L330,170 Z" class="region-neutral" data-region="budapest">
            <title>Budapest: a C-26 kizárólag budapesti projektekre vonatkozik (jogosult)</title>
          </path>
        ...
        <div class="region-legend">
          <div class="region-legend-item"><span class="region-dot region-dot-priority"></span> <strong>Kiemelt régió (más pályázatoknál +2 pont)</strong></div>
          <div class="region-legend-item"><span class="region-dot region-dot-neutral"></span> C-26 célterület / egyéb (0 pont)</div>
        </div>
        ...
        <div class="region-details">
          ...
          <div class="region-col">
            <h4 style="color:var(--gray-700)">Egyéb régiók (nem jogosult a C-26-ra)</h4>
            ...
            <h4 style="color:var(--blue);margin-top:12px">C-26 célterülete</h4>
            <p><strong>Budapest / Közép-Magyarország — a C-26 célterülete (kizárólag itt pályázható)</strong></p>
          </div>
        </div>
      </div>
    </div>
